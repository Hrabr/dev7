...
<div class="container">
    <form action="/companies" method="post">
     ...
     <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
      ...
      <br>
        <form>
          <input type="hidden"  value="<%=companies.getId_companies() %>"   name="companiesId">
          <div class="form-group row">
            <label for="Name_company" class="col-sm-2 col-form-label">Name company</label>
            <div class="col-sm-10">
              <input type="text" class="form-control"  value = "<%= companies.getName_companies() %>" id="Name_company"  placeholder="Input name company" name="Name_company">
            </div>
          </div>
          <br>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value = "<%= companies.getCountry_companies() %>" id="Country_company" placeholder="Input country company" name="Country_company">
            </div>
          </div>
